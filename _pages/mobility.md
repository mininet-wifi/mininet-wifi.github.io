...
The mobility models can be configured with `net.setMobilityModel()` like in `examples/mobilityModel.py`. In addition, you may want to take into account some parameters:
